...
start_function :: proc (main_container : ^zd.Eh) {
    filename := zd.new_datum_string ("test.abc")
...
components_to_include_in_project :: proc (leaves: ^[dynamic]zd.Leaf_Template) {
    ...
    zd.append_leaf (leaves, std.string_constant ("abc.ohm"))
    zd.append_leaf (leaves, std.string_constant ("abcjs.rwr"))
    zd.append_leaf (leaves, std.string_constant ("abccl.rwr"))
